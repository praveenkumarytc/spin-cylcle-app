...
import 'package:service/screen/schedule_pickup6.dart';
import 'package:service/utils/image.dart';

class SchedulePickup5 extends StatefulWidget {
  const SchedulePickup5({super.key});

  @override
  State<SchedulePickup5> createState() => _SchedulePickup5State();
}

class _SchedulePickup5State extends State<SchedulePickup5> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => SchedulePickup6()),
                  );
                },

...
import 'package:service/screen/schedule_pickup7.dart';
import 'package:service/utils/image.dart';

class SchedulePickup6 extends StatefulWidget {
  const SchedulePickup6({super.key});

  @override
  State<SchedulePickup6> createState() => _SchedulePickup6State();
}

class _SchedulePickup6State extends State<SchedulePickup6> {
  ...
  void splashScreen() async {
    await Future.delayed(Duration(seconds: 4), () {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => SchedulePickup7()),
      );
    });
  }
            ...
            content: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20),
                  Center(child: Text("Saving reflected after final payment")),
                ],
              ),
            ),
          ),
